package com.cre.ojcodesandbox.pythoncodesandbox;
...
@Slf4j
public class PythonCodeSandboxTemplate implements CodeSandbox {
    private static final String GLOBAL_CODE_DIR_NAME = "tmpCode";
    private static final String GLOBAL_CPP_FILE_NAME = "Main.py";
